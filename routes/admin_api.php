...
Route::prefix('admin')->middleware('auth:sanctum','is_role:admin')->group(function () {
    ...
    Route::get('/transaction/nth-highest-transaction-of-an-user/{user_id}', [TransactionController::class, 'get_nth_highest_transaction_of_an_user'])->name('api.admin.transaction.get_nth_highest_transaction_of_an_user');
});